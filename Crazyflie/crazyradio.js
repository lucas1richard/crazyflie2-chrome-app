  ...
  my.open = function(openedCb) {
    ...
    chrome.usb.getDevices(        {
      ...
      if (found_devices.length > 0) {
        ...
        $("#connectButtonNote").text("Opening Crazyradio dongle!");
        $("#connectButtonNote").css("color","green");
        chrome.usb.openDevice(device, function(handle) {
          console.log(handle);
          
          chrome.usb.claimInterface(handle, 500000, function () {
        ...
        $("#connectButtonNote").text("Cannot find Crazyradio dongle!");
        $("#connectButtonNote").css("color","red");
        openedCb(false);
      }
    });
  };
